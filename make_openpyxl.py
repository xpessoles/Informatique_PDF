...
def lire_semanier(path):
    ...
    #for k in range(1,2):
        #if 'Vacances' not in str(fscell_value(k,0)):
        if True : ######
            print(col_date+str(k))
            cell = fs[col_date+str(k)]
            delta = datetime.timedelta(days=(cell.value-2))
